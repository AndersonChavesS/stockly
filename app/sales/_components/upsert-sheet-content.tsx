...
import UpsertSaleTableDropdowMenu from "./upsert-table-dropdown-menu";
  ...
  return (
    <SheetContent className="!max-w-[700px]">
      ...
      <Form {...form}>
        <form className="space-y-6 py-6" onSubmit={form.handleSubmit(onSubmit)}>
          ...
          <Button
            type="submit"
            variant="secondary"
            className="w-full gap-2 duration-200 hover:bg-blue-500 hover:text-white"
          >
            <PlusIcon size={20} />
        ...
        <TableBody>
          {selectedProducts.map((product) => (
            <TableRow key={product.id}>
              ...
              <TableCell>
                <UpsertSaleTableDropdowMenu product={product} onDelete={onDelete} />
              </TableCell>
              <TableCell></TableCell>
            </TableRow>
          ))}
      ...
      <SheetFooter className="pt-6">
        <Button
          className="w-full gap-2 bg-blue-800 duration-300 hover:bg-blue-500"
